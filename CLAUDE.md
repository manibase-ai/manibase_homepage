...
## Deployment
- **Status: STAGING / NICHT PRODUKTIV.** `manibase.aicoreinfra.de` ist ein Preview-Deploy, nicht die produktive Marken-Domain. **Vor produktivem Launch müssen die P1-Issues gefixt sein:** [#2](https://github.com/schauersbergern/manibase_homepage/issues/2) Newsletter sendet nichts, [#3](https://github.com/schauersbergern/manibase_homepage/issues/3) Qualifizierungs-Wizard verwirft alle Antworten, [#4](https://github.com/schauersbergern/manibase_homepage/issues/4) Datenschutz-Text widersprüchlich/unfertig.
- **Live-Domain (Staging):** `manibase.aicoreinfra.de` (Server `deploy@72.62.42.27`, Ubuntu 24.04, nginx + certbot; Schwester-Subdomains radar/employees/kva/n8n liegen auf demselben Host).
