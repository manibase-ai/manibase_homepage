...
- **Offen (organisatorisch):** AVV Hostinger abschließen (Zeeg- und Odoo-AVV liegen bei). Optional: Double-Opt-In nachrüsten (Odoo-App *Marketing Automation* + „Double Opt-in"-Kampagne auf Liste id 1) → dann Datenschutz-Abschnitt 7 auf DOI umformulieren.
